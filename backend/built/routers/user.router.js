        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (user) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("אמייל או סיסמא לא תקינים");
                }
                return [2 /*return*/];
        }
    });
}); }));
router.post("/remove", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var email, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, user_model_1.UserModel.deleteOne({ email: email })];
            case 2:
                _a.sent();
                res.status(200).json({ message: 'User removed successfully' });
                console.log("User with email '".concat(email, "' removed successfully."));
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
                res.status(http_status_1.HTTP_BAD_REQUEST).send("Error while removing user");
                console.error('Error while removing user:', err_1);
                return [3 /*break*/, 4];
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, address, schoolName, schoolCode, grade, charactter, role, user, user_1, encryptedPassword, newUser, dbUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("inside register");
                _a = req.body, name = _a.name, email = _a.email, password = _a.password, address = _a.address, schoolName = _a.schoolName, schoolCode = _a.schoolCode, grade = _a.grade, charactter = _a.charactter, role = _a.role;
                return [4 /*yield*/, user_model_1.UserModel.findOne({ email: email })];
            case 1:
                user = _b.sent();
                if (user) {
                ...
                if (!(role == "teacher")) return [3 /*break*/, 3];
                return [4 /*yield*/, user_model_1.UserModel.findOne({ schoolCode: schoolCode, role: "admin" })];
            case 2:
                user_1 = _b.sent();
                if (!user_1) {
